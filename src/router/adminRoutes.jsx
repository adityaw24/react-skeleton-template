...
import { ProductDetailPage, ProductFormPage, ProductListPage } from "~/views";
...
const adminRouter = [
  {
    ...
    children: [
      ...
      { path: "/product/form", element: <ProductFormPage /> },
      { path: "/product/form/:id", element: <ProductFormPage /> },
